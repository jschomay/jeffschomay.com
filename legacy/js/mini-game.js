...
Game = (function () {
  ...
  Game.prototype.renderImageFragment = function (cb) {
    ...
    output = [
      {
        s:
          '<br/><br/><span style="color:lightgreen;">[LOADING IMAGE FRAGMENT ' +
      ...
      },
      {
        d: 1000,
        s:
          '<br/><div class="fragment" style="background: url(' +
          f.src +
          "); background-position: " +
  ...
  Game.prototype.checkKey = function (id) {
    ...
    if (id === this.images[this.currentImageFragmentNumber].key) {
      ...
      $image.css({
        "background-image":
          "url(" + this.images[this.currentImageFragmentNumber].src + ")",
      ...
      output = [
        {
          s:
            "<br/><br/>User input: " +
            id +
            '<br/><span style="color: lightgreen;">Success: Valid asset key match.  Relinking image.'
        },
        {
          d: 1200,
        ...
        },
        {
          ...
          s:
            ...
            this.correctResponses[
              Math.floor(Math.random() * this.correctResponses.length)
            ] +
            " " +
            this.images[this.currentImageFragmentNumber].info
        }
      ];
      ...
      output = [
        {
          s:
            "<br/><br/>User input: " +
            id +
            '<br/><span style="color: red;">Error:</span> Non-matching key, unable to link asset'
        },
        {
          d: 800,
          s:
            '<br/><br/><span style="color:yellow;"> &nbsp;' +
            " getTime " +
            "jschomay: </span>" +
            this.missResponses[
              Math.floor(Math.random() * this.missResponses.length)
            ]
        }
      ];
  ...
  Game.prototype.introSequence = [
    {
      s:
        "<br/>" +
        "getDate" +
        ' - <span style="color: red;">ERROR (42): GUI crashed - User pressed the wrong button</span>'
    },
    {
      d: 2000,
      s:
        "<br/>&nbsp; &nbsp; &nbsp; &nbsp; Button id: #dont-push (index.html:32:17)"
    },
    {
      d: 100,
      s:
        "<br/>&nbsp; &nbsp; &nbsp; &nbsp; Event type: click ([object Object])<br/><br/>"
    },
    {
      d: 2500,
    ...
    },
    {
      d: 1100,
      s:
        '<br/><span style="color:lightgreen;">[MANUAL OVERRIDE MODE ACTIVE]</span>'
    },
    {
      d: 1500,
    ...
    },
    {
      ...
      s:
        '<br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay: </span>You pressed the button, didn't you."
    },
    {
      d: 3000,
      s:
        '<br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay: </span>I <em>knew </em>you were going to press that button!!"
    },
    {
      d: 3500,
      s:
        '<br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay: </span>It's ok, we can fix this.  I just need a little help from you to reconnect my image assets to their database keys.  Think of it as a game.  And you'll learn some less known facts about me along the way.  One second..."
    }
  ];
  ...
  Game.prototype.sequence2 = [
    {
      s:
        '<br/><br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay - </span>Ok, it's your turn.  Click on the blue asset key you think this image fragment fits with."
    }
  ];
  ...
  Game.prototype.finalSequence = [
    {
      s:
        '<br/><br/><span style="color:lightgreen;">[IMAGE ASSET KEYS SUCCESSFULLY REBUILT]</span>'
    },
    {
      d: 500,
    ...
    },
    {
      ...
      s:
        '<br/><br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay - </span>Nice!  Looks like you fixed all the image asset keys, thanks for your help!"
    },
    {
      d: 4500,
      s:
        '<br/><span style="color:yellow;"> &nbsp;' +
        " getTime " +
        "jschomay - </span>I'll send  you back to the main site in just a second... bye!"
    }
  ];
  ...
  Game.prototype.images = [
    ...
    },
    {
      ...
      key: "travel",
      info:
        "I lived in Europe for 5 years when I was young, and have traveled around the world."
    }
  ];
  ...
  Game.prototype.correctResponses = [
    "Nice, you got it.",
    "That's right!",
    "That's a match.",
    "Correct.",
